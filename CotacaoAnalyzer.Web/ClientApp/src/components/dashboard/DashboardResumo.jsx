...
const DashboardResumo = ({ dashboardResumo }) => {
    ...
    const configOptions = [
        { label: "Estoques Ativos", icon: "fas fa-warehouse", path: "/administrador/estoques"},
        { label: "Produtos nos Estoques", icon: "fas fa-boxes", path: "/administrador/estoques"},
        { label: "Revendedores Ativos", icon: "fas fa-user-tie", path: "/administrador/revendedores"},
        { label: "Média de comissão Revendedores", icon: "fas fa-percentage", path: "#" },
    ];
